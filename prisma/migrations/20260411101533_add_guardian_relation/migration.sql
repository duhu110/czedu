/*
  ...
  - Added the required column `guardian1Relation` to the `Application` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Application" ("adminRemark", "createdAt", "currentGrade", "currentSchool", "ethnicity", "fileHukou", "fileProperty", "fileResidencePermit", "fileStudentCard", "gender", "guardian1Name", "guardian1Phone", "guardian2Name", "guardian2Phone", "hukouAddress", "id", "idCard", "livingAddress", "name", "residencyType", "semesterId", "status", "studentId", "targetGrade", "targetSchool", "updatedAt") SELECT "adminRemark", "createdAt", "currentGrade", "currentSchool", "ethnicity", "fileHukou", "fileProperty", "fileResidencePermit", "fileStudentCard", "gender", "guardian1Name", "guardian1Phone", "guardian2Name", "guardian2Phone", "hukouAddress", "id", "idCard", "livingAddress", "name", "residencyType", "semesterId", "status", "studentId", "targetGrade", "targetSchool", "updatedAt" FROM "Application";
